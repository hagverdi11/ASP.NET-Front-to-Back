#pragma checksum "C:\Users\HP\Desktop\ASP.Net\FrontToBack\FrontToBack\FrontToBack\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6cb7b9061e3c2bbe85a253bd7ad618549c4029a6"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6cb7b9061e3c2bbe85a253bd7ad618549c4029a6", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\HP\Desktop\ASP.Net\FrontToBack\FrontToBack\FrontToBack\Views\Home\Index.cshtml"
...
<div class=""banner-wrapper bg-light"">
    <div id=""index_banner"" style=""background-image: url(~/wwwroot/assets/img/banner-bg-01.jpg)"" class=""banner-vertical-center-index container-fluid pt-5"">
                ...
                <div class=""carousel-item active"">
                    ...
                    <div class=""py-5 row d-flex align-items-center"">
                        <div class=""banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5"">
                            <h1 class=""bann");
            WriteLiteral(@"er-heading h1 text-secondary display-3 mb-0 pb-5 mx-0 px-0 light-300 typo-space-line"">
                            ...
                            <a class=""banner-button btn rounded-pill btn-outline-primary btn-lg px-4"" href=""#"" role");
            WriteLiteral(@"=""button"">Get Started</a>
                        </div>
                    </div>
...
<section class=""container overflow-hidden py-5"">
    <div class=""row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-");
            WriteLiteral(@"3 pb-3 projects"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm o");
            WriteLiteral(@"verflow-hidden mx-5 m-sm-0"">
  ...
  ");
            ...
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                ...
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
                        ...
                        <p c");
            WriteLiteral(@"lass=""card-text"">Lorem ipsum dolor sit amet, consectetur adipisicing</p>
                    </div>
                </div>
            </a>
        </div><!-- End Recent Work -->
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""");
            WriteLiteral(@"card-img"" src=""./assets/img/services-07.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic branding"">
            ...
            WriteLiteral(@"text-left text-light"">
    ...
    <div class=""container py-5"">
        <div class=""row d-flex justify-content-center text-center"">
            ...
            <div class=""col-lg-3 col-12 pt-4"">
                <a h");
            WriteLiteral(@"ref=""#"" class=""btn btn-primary rounded-pill btn-block shadow px-4 py-2"">View Our Work</a>
            </div>
        </div>
    </div>
</section>
       ...
       ");
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    ...
                    <div class=""re");
            WriteLiteral(@"cent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
                ...
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    ...
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
                            ...
                            <p cla");
            WriteLiteral(@"ss=""card-text"">Put enim ad minim veniam</p>
                        </div>
                    </div>
                </a>
            </div><!-- End Recent Work -->
